# Вариант 19 — OSPF, Port Security и проверка работоспособности без NAT, Packet Tracer

Для **варианта 19** по заданию нужно:
- использовать **протокол маршрутизации OSPF**;
- настроить **Port Security**;
- проверить **работоспособность сети без использования NAT**. fileciteturn14file6

Общие требования также включают 3 роутера, 4 коммутатора, 4 ПК, DHCP, trunk, минимум 2 VLAN, ACL, VTP, SNMP и проверку ARP. Для этого варианта **NAT не настраивается**. fileciteturn14file9turn14file10

> В этой версии задействованы **все устройства**:
> - **R1** — центральный роутер, DHCP, ACL, OSPF
> - **R2** — шлюз VLAN 10
> - **R3** — шлюз VLAN 20
> - **SW1 + SW2** — левая ветка
